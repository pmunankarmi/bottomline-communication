...
check( get_option( 'options_bl_logo_url' ) === wp_get_attachment_image_url( $images[0], 'full' ), 'Customizer logo syncs to theme options' );
update_option( 'options_bl_logo_url', wp_get_attachment_image_url( $images[1], 'full' ) );
$_POST['acf']['field_bl_logo_url'] = wp_get_attachment_image_url( $images[1], 'full' );
...
$_POST['acf']['field_bl_logo_url'] = ''; update_option( 'options_bl_logo_url', '' ); do_action( 'acf/save_post', 'options' );
check( ! get_theme_mod( 'custom_logo' ) && '' === get_option( 'options_bl_logo_url' ), 'Logo removal syncs in both places' );
