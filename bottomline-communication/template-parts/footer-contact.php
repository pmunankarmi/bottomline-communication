...
<footer>
  <div class="foot-grid row g-5">
    <div class="col-lg-5 foot-brand">
      <a href="<?php echo esc_url( bl_url( bl_value('bl_global_footer_010', 'index.html', 'option') ) ); ?>" class="logo"><img class="brand-logo" src="<?php echo esc_url( bl_url( bl_value('bl_global_footer_002', 'bottomline-logo-white.svg?v=2', 'option') ) ); ?>" alt="<?php echo esc_attr( bl_value('bl_global_footer_003', 'BottomLine', 'option') ); ?>" /></a>
