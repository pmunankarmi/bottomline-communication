  ...
  <div class="contact-grid row g-5 align-items-start">
    <div class="col-lg-7 form-card-wrap"><div class="form-card" id="formCard">
      <form id="briefForm" data-validation="jquery" <?php if ( bl_brief_sent() ) echo 'hidden'; ?> method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
        <?php wp_nonce_field( 'bl_brief', 'bl_nonce' ); ?><input type="hidden" name="action" value="bl_brief" /><div hidden><label><?php echo esc_html( bl_value( 'bl_contact_copy_1', 'Leave empty', get_queried_object_id() ) ); ?><input name="website" tabindex="-1" autocomplete="off" /></label></div><?php bl_form_notice(); ?><div class="form-row row g-3">
          <div class="col-md-6 field">
            ...
            <input type="text" name="name" data-msg-required="Please enter your full name." required placeholder="<?php echo esc_attr( bl_value('bl_contact_007', 'Your name', get_queried_object_id()) ); ?>" />
          </div>
          <div class="col-md-6 field">
            ...
            <input type="email" name="email" data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." required placeholder="<?php echo esc_attr( bl_value('bl_contact_009', 'you@company.com', get_queried_object_id()) ); ?>" />
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="field">
            ...
            <textarea name="message" data-msg-required="Please tell us about your project." required placeholder="<?php echo esc_attr( bl_value('bl_contact_034', 'Objective, audience, scope, references — whatever helps us understand.', get_queried_object_id()) ); ?>"></textarea>
          </div>
        </div>
